        ...
        if (filtered.length > 0) {
          filtered.forEach((person) => {
            ...
            li.onclick = () => {
              ...
              window.location.href = `workers-card.html?name=${encodedName}`;
            };
      ...
      if (person) {
        ...
        detailsBox.innerHTML = `
         ...
         <p> ${person.name}</p>
          ...
          <div class="detail-group">
            <img src="images/cards/plug.png" alt="img">
            <h3>Date of joining the church</h3>
            <p> ${person.church_birthday}</p>
            <h3>Date of joining the workforce</h3>
            <p> ${person.workers_day}</p>
          </div>

          <div class="detail-group">
            <img src="images/cards/networking.png" alt="img">
            <h3>Department</h3>
